...
import aHuman from "../../assest/About/Image.png"
...
function About() {
  ...
  return (
    <>
      <div className={darkMode ? "about-dark dark-mode":"about-light light-mode"}>
        <Title namePage={namePage} />
        <img className='about__picture' src={aHuman} alt="" />
        <h3>About Me</h3>
